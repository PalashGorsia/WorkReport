...
class PersonalHealthInProgressAdapter(
...
) : RecyclerView.Adapter<PersonalHealthInProgressAdapter.AddDietPlanViewHolder>() {
    ...
    private lateinit var questionAdapter: QuestionInProgressAdapter
...
//InspectionContent
    ...
    fun swapList(list: Data2, pos: Int) {
       // dataM = Data2(AdditionalInfo(""),ArrayList())
        ...
        fun bind(entity: Content) {
            ...
            binding.apply {
             ...
             //   data =entity
                ...
                questionAdapter = QuestionInProgressAdapter(context, false,viewModel,dataM){
    ...
    private fun getDataFormDatabase(questionAdapter: QuestionInProgressAdapter, pos: Int) {
        context.lifecycleScope.launch {
         //   xtnLog("Date $mDate")
           val it =  viewModel.getCheckListBasedOnJob()
           val dataM2 = Gson().fromJson(it.json, Data2::class.java)
