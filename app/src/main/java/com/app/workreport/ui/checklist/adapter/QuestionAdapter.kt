...
class QuestionAdapter(
    ...
    RecyclerView.Adapter<QuestionAdapter.AddDietPlanViewHolder>() {
    private var list: ArrayList<Todo2> = ArrayList()//mutableListOf<Todo>()
    private var adepterPo = -1

    /// private var dataM:Data? = data
    var titlePo = -1
    var tabPo = -1
    var dataStatus = 2
    var date: String = ""
...
*/
    ...
    private fun getDataFormDatabase() {
        context.lifecycleScope.launch {
            ...
            dataM = Gson().fromJson(it.json, Data::class.java)
